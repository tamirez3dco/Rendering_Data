...
def run(ring_rad_diff, n_ring_divisions, n_circle_divisions, in_circle_rad_x, out_circle_rad_x, in_circle_rad_y, out_circle_rad_y, div_pipe_rad, in_pipe_rad, out_pipe_rad, division_shift):
    ...
    #in_circle_rad_x = in_circle_rad-1
    #in_circle_rad_y = in_circle_rad+1
    #out_circle_rad_x = out_circle_rad+1
...
def RunCommand( is_interactive ):
    ...
    a10_o = Rhino.Input.Custom.OptionDouble(0.3)
    a11_o = Rhino.Input.Custom.OptionDouble(0.5)
    ...
    go.AddOptionDouble("a10", a10_o)
    go.AddOptionDouble("a11", a11_o)
    ...
    a10 = a10_o.CurrentValue
    a11 = a11_o.CurrentValue
    
    rs.EnableRedraw(False)
    run(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11)
