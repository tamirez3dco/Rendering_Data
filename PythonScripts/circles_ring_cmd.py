...
__commandname__ = "circles_rings"
def run(ring_rad_diff, n_ring_divisions, n_circle_divisions, width, hole, div_pipe_rad, circle_pipe_rad, division_shift):
    ...
    if rhole<0:
        in_circle_rad = width
        out_circle_rad = width + rhole
    else:
        out_circle_rad = width
        in_circle_rad = width - rhole  
 
    div_pipe_rad = (1.1 * div_pipe_rad) + 0.2
    in_pipe_rad = (1.1 * circle_pipe_rad) + 0.2
    out_pipe_rad = in_pipe_rad
